"""Audit metrics for multilabel diagnostics."""
...
from separatix.multilabel.validation import ValidatedMultilabelInput


def _top_label_counts(
    names: np.ndarray, counts: np.ndarray, *, limit: int = 10
) -> list[dict[str, Any]]:
    """Return the largest label counts in report-friendly form."""
